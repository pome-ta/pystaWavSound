# [[python]　sin波の音をWAV形式で出力する - Qiita](https://qiita.com/kinaonao/items/c3f2ef224878fbd232f5)
...
def create_wave(A, f0, fs, t):  #A:振幅,f0:基本周波数,fs:サンプリング周波数,再生時間[s]
  ...
  #サイン波をwavファイルとして書き出し
  w = wave.Wave_write('./out/440Hz.wav')
  p = (
    1, 2, fs, len(binwave), 'NONE', 'not compressed'
